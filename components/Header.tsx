...
export default function Example() {
  ...
  const stats = [
    { name: "Cortes", value: "+2000 valoraciones" },
    { name: "Tratamientos", value: "+2000 valoraciones" },
    { name: "Alisados", value: "+2000 valoraciones" },
    { name: "Mechas - Color", value: "+1000 valoraciones" },
  ];
      ...
      <div className="relative isolate overflow-hidden bg-[#5D4037] pb-24 sm:pb-32">
        ...
        <div className="flex flex-col  mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            <h2 className="text-4xl font-bold tracking-tight py-10 text-white sm:text-6xl">
              Peluqueria <p>How 'U want</p>
            </h2>
          </div>
          <div className="mx-auto pt-36 mt-10 max-w-2xl h-48 lg:mx-0 lg:max-w-none">
            <dl className="mt-16 grid grid-cols-1  gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
              {stats.map((stat) => (
                <div key={stat.name} className="flex flex-col-reverse">
                  <dt className="leading-7 text-gray-300 text-2xl">
                    {stat.name}
                  </dt>
